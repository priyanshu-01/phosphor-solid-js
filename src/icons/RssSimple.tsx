...
const renderPathFor = (weight: string, color: string) => {
  ...
  <path d="M56,120a80,80,0,0,1,80,80" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <circle cx="56" cy="200" r="16"/>
    ...
    case "duotone":
      return (
        <>
          <path d="M55.99414,48a152,152,0,0,1,152,152" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <path d="M55.99414,120a80,80,0,0,1,80,80" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  ...
  <path d="M56,120a80,80,0,0,1,80,80" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  ...
  <path d="M56,120a80,80,0,0,1,80,80" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
