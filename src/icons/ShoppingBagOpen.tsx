...
const renderPathFor = (weight: string, color: string) => {
  ...
  <line x1="32" y1="88" x2="224" y2="88" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <path d="M168,124a40,40,0,0,1-80,0" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
        </>
      )
    case "duotone":
      return (
