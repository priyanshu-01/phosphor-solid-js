...
const renderPathFor = (weight: string, color: string) => {
  ...
  <path d="M218.5374,96A95.90174,95.90174,0,1,1,143.13974,33.187" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
        </>
      )
    case "duotone":
      return (
  ...
  <path d="M218.5374,96A95.90174,95.90174,0,1,1,143.13974,33.187" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
        </>
      )
    case "thin":
      return (
  ...
  <path d="M218.5374,96A95.90174,95.90174,0,1,1,143.13974,33.187" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
        </>
      )
    case "regular":
      return (
