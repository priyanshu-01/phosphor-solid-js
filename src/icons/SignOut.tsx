...
const renderPathFor = (weight: string, color: string) => {
  switch (weight) {
    case "bold":
      return (
        <>
          <polyline points="174.029 86 216.029 128 174.029 170" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
  ...
  <path d="M120,216H48a8,8,0,0,1-8-8V48a8,8,0,0,1,8-8h72" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"/>
    ...
    case "duotone":
      return (
        <>
          <polyline points="174.029 86 216.029 128 174.029 170" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
  ...
  <path d="M120,216H48a8,8,0,0,1-8-8V48a8,8,0,0,1,8-8h72" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
    ...
    case "light":
      return (
        <>
          <polyline points="174.029 86 216.029 128 174.029 170" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <path d="M120,216H48a8,8,0,0,1-8-8V48a8,8,0,0,1,8-8h72" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
    ...
    case "thin":
      return (
        <>
          <polyline points="174.029 86 216.029 128 174.029 170" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
