...
const renderPathFor = (weight: string, color: string) => {
  ...
  <line x1="96" y1="156" x2="160" y2="156" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <line x1="96" y1="116" x2="160" y2="116" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
        </>
      )
    case "duotone":
      return (
