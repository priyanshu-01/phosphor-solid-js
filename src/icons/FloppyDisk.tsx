...
const renderPathFor = (weight: string, color: string) => {
  ...
  <circle cx="128" cy="156" r="24" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <polyline points="156 92.009 100 92.009 100 40.009" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
        </>
      )
    case "duotone":
      return (
