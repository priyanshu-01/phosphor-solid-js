...
const renderPathFor = (weight: string, color: string) => {
  ...
  <polygon points="168 156 132 128 168 100 168 156" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <polygon points="112 156 76 128 112 100 112 156" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
