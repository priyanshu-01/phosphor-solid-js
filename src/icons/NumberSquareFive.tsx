...
const renderPathFor = (weight: string, color: string) => {
  switch (weight) {
    case "bold":
      return (
        <>
          <path d="M152,80H111.83477L104,128.20232a27.99935,27.99935,0,1,1,0,39.5969" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <rect x="40" y="40" width="176" height="176" rx="8" strokeWidth="16" stroke={color} strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    ...
    case "light":
      return (
        <>
          <path d="M152,80H111.83477L104,128.20232a27.99935,27.99935,0,1,1,0,39.5969" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  <rect x="40" y="40" width="176" height="176" rx="8" strokeWidth="12" stroke={color} strokeLinecap="round" strokeLinejoin="round" fill="none"/>
    ...
    case "thin":
      return (
        <>
          <path d="M152,80H111.83477L104,128.20232a27.99935,27.99935,0,1,1,0,39.5969" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
