...
const renderPathFor = (weight: string, color: string) => {
  switch (weight) {
    case "bold":
      return (
        <>
          <rect x="56" y="48" width="144" height="180" rx="16" stroke-width="24" stroke={color} stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  ...
  <circle cx="128" cy="176" r="12"/>
    ...
    case "light":
      return (
        <>
          <line x1="128" y1="100" x2="128" y2="140" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="12"/>
  ...
  <circle cx="128" cy="176" r="10"/>
    ...
    case "thin":
      return (
        <>
          <line x1="128" y1="100" x2="128" y2="140" fill="none" stroke={color} stroke-linecap="round" stroke-linejoin="round" stroke-width="8"/>
