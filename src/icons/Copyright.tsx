...
const renderPathFor = (weight: string, color: string) => {
  ...
  <path d="M160.00112,152.00142a40,40,0,1,1-.00029-48.013" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
        </>
      )
    case "duotone":
      return (
  ...
  <path d="M160.00112,152.00142a40,40,0,1,1-.00029-48.013" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
        </>
      )
    case "thin":
      return (
  ...
  <path d="M160.00112,152.00142a40,40,0,1,1-.00029-48.013" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
        </>
      )
    case "regular":
      return (
