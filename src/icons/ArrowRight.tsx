...
const renderPathFor = (weight: string, color: string) => {
  ...
  <polyline points="144 56 216 128 144 200" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
        </>
      )
    case "duotone":
      return (
  ...
  <polyline points="144 56 216 128 144 200" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
        </>
      )
    case "thin":
      return (
  ...
  <polyline points="144 56 216 128 144 200" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
        </>
      )
    case "regular":
      return (
