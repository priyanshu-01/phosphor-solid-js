...
const renderPathFor = (weight: string, color: string) => {
  ...
  <polyline points="176.648 181.512 119.994 224.003 119.994 119.194" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <polyline points="119.994 59.729 119.994 32.003 183.994 80.003 156.899 100.324" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
        </>
      )
    case "duotone":
      return (
