...
const renderPathFor = (weight: string, color: string) => {
  ...
  <line x1="96" y1="92" x2="96" y2="164" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <polygon points="104 128 160 92 160 164 104 128" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
        </>
      )
    case "duotone":
      return (
