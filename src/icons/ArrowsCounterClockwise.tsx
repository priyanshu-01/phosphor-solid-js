...
const renderPathFor = (weight: string, color: string) => {
  ...
  <path d="M190.2254,65.7746a88,88,0,0,0-124.4508,0L31.83348,99.71573" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <polyline points="176.167 156.284 224.167 156.284 224.167 204.284" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  <path d="M65.7746,190.2254a88,88,0,0,0,124.4508,0l33.94112-33.94113" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
        </>
      )
    case "duotone":
      return (
  ...
  <path d="M190.2254,65.7746a88,88,0,0,0-124.4508,0L31.83348,99.71573" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <polyline points="176.167 156.284 224.167 156.284 224.167 204.284" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
  <path d="M65.7746,190.2254a88,88,0,0,0,124.4508,0l33.94112-33.94113" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="16"/>
        </>
      )
    case "fill":
      return (
  ...
  <path d="M190.2254,65.7746a88,88,0,0,0-124.4508,0L31.83348,99.71573" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  <polyline points="176.167 156.284 224.167 156.284 224.167 204.284" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  <path d="M65.7746,190.2254a88,88,0,0,0,124.4508,0l33.94112-33.94113" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
        </>
      )
    case "thin":
      return (
  ...
  <path d="M190.2254,65.7746a88,88,0,0,0-124.4508,0L31.83348,99.71573" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  <polyline points="176.167 156.284 224.167 156.284 224.167 204.284" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
  <path d="M65.7746,190.2254a88,88,0,0,0,124.4508,0l33.94112-33.94113" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
        </>
      )
    case "regular":
      return (
