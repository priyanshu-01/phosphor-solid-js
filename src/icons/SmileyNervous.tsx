...
const renderPathFor = (weight: string, color: string) => {
  ...
  <polyline points="85.791 164.762 96 152 112 172 128 152 144 172 160 152 170.21 164.762" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="24"/>
  ...
  <polyline points="80 172 96 152 112 172 128 152 144 172 160 152 176 172" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="12"/>
  ...
  <polyline points="80 172 96 152 112 172 128 152 144 172 160 152 176 172" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="8"/>
